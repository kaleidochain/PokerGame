"use strict";
cc._RF.push(module, 'ac4fe91+VxMJIm33gDEwa4l', 'TexasHoldemTutorial');
// scripts/Game/TexasHoldemTutorial.js
...
cc.Class({
  ...
  properties: {
    ...
    //触摸快进层
    touchLayer: cc.Node,
    //点击后跳过引导等待时间，Button层出现后消失
    buttonLayer: cc.Node,
    //引导结束层
    //Preflop轮提示
    preflopTutorial: cc.Node,
    //preflop轮提示层
    preflopBigBlindFocus: cc.Node,
    //preflop轮大盲提示层
    preflopBigBlindUntips: cc.Node,
    //preflop轮大盲未提示
    preflopBigBlindTextTips: cc.Node,
    //preflop轮大盲文字提示
    preflopBigBlindFocusMask: cc.Node,
    //preflop轮大盲提示蒙层
    preflopBigBlindFocusShadow: cc.Node,
    //preflop轮大盲提示阴影
    preflopSmallBlindFocus: cc.Node,
    //preflop轮小盲提示层
    preflopSmallBlindUntips: cc.Node,
    //preflop轮小盲未提示
    preflopSmallBlindTextTips: cc.Node,
    //preflop轮小盲文字提示
    preflopSmallBlindFocusMask: cc.Node,
    //preflop轮小盲提示蒙层
    preflopSmallBlindFocusShadow: cc.Node,
    //preflop轮小盲提示阴影
    preflopDealerFocus: cc.Node,
    //preflop轮小盲提示层
    preflopDealerUntips: cc.Node,
    //preflop轮小盲未提示
    preflopDealerTextTips: cc.Node,
    //preflop轮小盲文字提示
    preflopDealerFocusMask: cc.Node,
    //preflop轮小盲提示蒙层
    preflopDealerFocusShadow: cc.Node,
    //preflop轮小盲提示阴影
    //Pop提示
    potTutorial: cc.Node,
    //底池提示
    potTextTips: cc.Node,
    //底池文字提示，Y坐标=底牌Y坐标+75
    potFocusMask: cc.Node,
    //底池提示蒙层，Y坐标=底池Y坐标
    potFocusShadow: cc.Node,
    //底池提示阴影，Y坐标=-底池Y坐标
    //HoleCards提示
    holeCardsTutorial: cc.Node,
    //底牌提示
    holeCardsTextTips: cc.Node,
    //底牌文字提示，Y坐标=底牌Y坐标+150
    holeCardsFocusMask: cc.Node,
    //底牌提示蒙层，Y坐标=底牌Y坐标+60
    holeCardsFocusShadow: cc.Node,
    //底牌提示阴影，Y坐标=-(底牌Y坐标+60)
    //Flop轮提示
    flopTutorial: cc.Node,
    //Flop牌提示
    flopTextTips: cc.Node,
    //Flop牌文字提示，Y坐标=第二张Flop牌Y坐标+140
    flopFocusMask: cc.Node,
    //Flop牌提示蒙层，Y坐标=第二张Flop牌Y坐标+50
    flopFocusShadow: cc.Node,
    //Flop牌提示阴影，Y坐标=-(第二张Flop牌Y坐标+50)
    //Turn轮提示
    turnTutorial: cc.Node,
    //Turn牌提示
    turnTextTips: cc.Node,
    //Turn牌文字提示，Y坐标=Turn牌Y坐标+140
    turnFocusMask: cc.Node,
    //Turn牌提示蒙层，Y坐标=Turn牌Y坐标+50
    turnFocusShadow: cc.Node,
    //Turn牌提示阴影，Y坐标=-(Turn牌Y坐标+50)
    //River轮提示
    riverTutorial: cc.Node,
    //River牌提示
    riverTextTips: cc.Node,
    //River牌文字提示，Y坐标=River牌Y坐标+140
    riverFocusMask: cc.Node,
    //River牌提示蒙层，Y坐标=River牌Y坐标+50
    riverFocusShadow: cc.Node,
    //River牌提示阴影，Y坐标=-(River牌Y坐标+50)
    //摊牌轮提示
    showdownTutorial: cc.Node,
    //摊牌轮提示层
    showdownCommunityFocusMask: cc.Node,
    //摊牌轮公共牌提示蒙层
    showdownCommunityFocusShadow: cc.Node,
    //摊牌轮公共牌提示蒙层阴影
    showdownHoleCardsFocusMask: cc.Node,
    //摊牌轮底牌提示蒙层
    showdownHoleCardsFocusShadow: cc.Node,
    //摊牌轮底牌提示蒙层阴影
    showdownCardTypeTextTips: cc.Node,
    //摊牌轮牌型文字提示
    showdownCardTypeFocusMask: cc.Node,
    //摊牌轮牌型提示蒙层
  ...
  onLoad: function onLoad() {
    ...
    for (var _i2 = 0; _i2 < this.dealPublicCards.length; _i2++) {
      var _cardNode = cc.instantiate(this.pokerPrefab);

      this.dealPublicCards[_i2].addChild(_cardNode);
    ...
    cc.find("Canvas/TableInfoLayer/layoutTableInfo/btnTableInfo/btn_tableinfo_off").active = !cc.find("Canvas/TableInfoDetailLayer").active; //座位编号规则：
    //最底为0号位，自身玩家的位置，后面的位置从0号位开始顺时针按顺序排号，玩家任意选座后会以距离0号位置最近的方向（顺时针/逆时针）旋转至0号位置坐下

    this.playerTables = {};
    this.playerAnchors = {}; //9人桌各位置使用的预制资源
    ...
    var newOriginWorldPT = null; //console.log("WxH: " + cc.winSize.width + "x" + cc.winSize.height);
    ...
    var playerInfos = [{
      ...
      "nickname": "e2A04360",
      "stackNum": 20000,
      "status": Types.ContractStatus.PLAYING
    }, {
      "pos": 1,
      "addr": "0x5806dc65",
      "nickname": "5806dc65",
    ...
    for (var i = 0; i < this._maxPlayers; i++) {
      ...
      player.initPlayerInfo(playerInfos[i].pos, playerInfos[i].addr, playerInfos[i].nickname, playerInfos[i].stackNum, playerInfos[i].status); // player.startCountDown(15);
      ...
      if (i == 0) {
        ...
        var communityCardLayer = cc.find("Canvas/PublicCardsLayer");
        ...
        var newpos = this.dealerMark.parent.convertToNodeSpaceAR(player.getDealerMarkPos());
  ...
  onBtnPlayNowClicked: function onBtnPlayNowClicked() {
  ...
  onBtnLearnMoreRulesClicked: function onBtnLearnMoreRulesClicked() {
    var tutorial = JSON.parse(cc.sys.localStorage.getItem("tutorial"));
    tutorial.TexasHoldem = true;
    cc.sys.localStorage.setItem("tutorial", JSON.stringify(tutorial));
  ...
  _countTimer: function _countTimer() {
    this._index++;
    ...
    if (this._index == 1) {
      ...
      for (var i = 3; i < 9; i++) {
        var playerAnchor = this.playerAnchors[this._maxPlayerStr][i];
        var player = playerAnchor.getChildren()[0].getComponent('Player');
        player.setBet(200, false);
        player.setStack(20000 - 200);
      ...
      var playerAnchor0 = this.playerAnchors[this._maxPlayerStr][0];
      var player0 = playerAnchor0.getChildren()[0].getComponent('Player');
      player0.setBet(200, false);
      player0.setStack(20000 - 200); //小盲

      var playerAnchor1 = this.playerAnchors[this._maxPlayerStr][1];
      var player1 = playerAnchor1.getChildren()[0].getComponent('Player');
      player1.setBet(200, false);
      player1.setStack(20000 - 200);
      player1.showAction(Types.PlayerOP.CALL); //大盲

      var playerAnchor2 = this.playerAnchors[this._maxPlayerStr][2];
      var player2 = playerAnchor2.getChildren()[0].getComponent('Player');
      ...
      for (var _i3 = 0; _i3 < 9; _i3++) {
        var _playerAnchor = this.playerAnchors[this._maxPlayerStr][_i3];

        var _player = _playerAnchor.getChildren()[0].getComponent('Player');

        _player.setBet(0, false);
      }
  ...
  _initPreflopTutorial: function _initPreflopTutorial() {
    //计算preflop轮各蒙层坐标
    //获取玩家坐标
    var player0WorldPT = this.playerAnchors[this._maxPlayerStr][0].convertToWorldSpaceAR(cc.v2(0, 0));

    var player1WorldPT = this.playerAnchors[this._maxPlayerStr][1].convertToWorldSpaceAR(cc.v2(0, 0));

    var player2WorldPT = this.playerAnchors[this._maxPlayerStr][2].convertToWorldSpaceAR(cc.v2(0, 0)); //console.log("player0WorldPT: " + player0WorldPT + ", player1WorldPT: " + player1WorldPT + ", player2WorldPT: " + player2WorldPT);
    //根据玩家坐标计算镂空层坐标


    var dealerMaskWorldPT = cc.v2(player0WorldPT.x, player0WorldPT.y + 45); //Dealer的Y坐标=玩家0的Y坐标+45

    var smallBlindMaskWorldPT = cc.v2(player1WorldPT.x + 170, player1WorldPT.y - 34); //小盲的Y坐标=玩家1的Y坐标-34

    var bigBlindMaskWorldPT = cc.v2(player2WorldPT.x + 170, player2WorldPT.y - 29); //大盲的Y坐标=玩家2的Y坐标-29
    ...
    var bigBlindFocusWorldPT = cc.v2(cc.winSize.width / 2, smallBlindMaskWorldPT.y + (bigBlindMaskWorldPT.y - smallBlindMaskWorldPT.y) / 2);
    var smallBlindFocusWorldPT = cc.v2(cc.winSize.width / 2, dealerMaskWorldPT.y + (smallBlindMaskWorldPT.y - dealerMaskWorldPT.y) / 2);
    var dealerFocusWorldPT = cc.v2(cc.winSize.width / 2, 0); //console.log("dealerFocusWorldPT: " + dealerFocusWorldPT + ", smallBlindFocusWorldPT: " + smallBlindFocusWorldPT + ", bigBlindFocusWorldPT: " + bigBlindFocusWorldPT);
    //设置各蒙层的位置
    ...
    this.preflopDealerFocus.setPosition(this.preflopDealerFocus.parent.convertToNodeSpaceAR(dealerFocusWorldPT)); //镂空与阴影的高度
    ...
    this.preflopBigBlindFocusShadow.height = cc.winSize.height - bigBlindFocusWorldPT.y; //设置镂空层坐标
    ...
    this.preflopDealerFocusMask.setPosition(this.preflopDealerFocusMask.parent.convertToNodeSpaceAR(dealerMaskWorldPT)); //设置阴影与提示的位置

    var preflopDealerFocusMaskPos = this.preflopDealerFocusMask.getPosition();
    var preflopSmallBlindFocusMaskPos = this.preflopSmallBlindFocusMask.getPosition();
    var preflopBigBlindFocusMaskPos = this.preflopBigBlindFocusMask.getPosition();
    ...
    var dealerTextTipsPos = this.preflopDealerFocusMask.getPosition();
    var smallBlindTextTipsPos = this.preflopSmallBlindFocusMask.getPosition();
    var bigBlindTextTipsPos = this.preflopBigBlindFocusMask.getPosition();
  ...
  _initPotTutorial: function _initPotTutorial() {
    //计算Pot各蒙层坐标
    var potLayer = cc.find("Canvas/PotLayer");
    var potWorldPT = potLayer.convertToWorldSpaceAR(cc.v2(0, 0));
    var potTextTipsWorldPT = cc.v2(potWorldPT.x, potWorldPT.y + 75);
    var potFocusMaskWorldPT = cc.v2(potWorldPT.x, potWorldPT.y); //console.log("potWorldPT: " + potWorldPT + ", potTextTipsWorldPT: " + potTextTipsWorldPT + ", potFocusMaskWorldPT: " + potFocusMaskWorldPT);
    ...
    var potFocusMaskPos = this.potFocusMask.getPosition();
  ...
  _initHoleCardsTutorial: function _initHoleCardsTutorial() {
    var poker0 = this.selfHoleCards[0].getChildren()[0].getComponent('Poker');
    var poker1 = this.selfHoleCards[1].getChildren()[0].getComponent('Poker');
    poker0.setCardPoint(11);
    poker1.setCardPoint(12);
    poker0.setFaceUp(true);
    poker1.setFaceUp(true); //计算底牌各蒙层坐标

    var holeCardsLayer = cc.find("Canvas/HoldCardsLayer");
    var holeCardsWorldPT = holeCardsLayer.convertToWorldSpaceAR(cc.v2(0, 0));
    var holeCardsTextTipsWorldPT = cc.v2(holeCardsWorldPT.x, holeCardsWorldPT.y + 150);
    var holeCardsFocusMaskWorldPT = cc.v2(holeCardsWorldPT.x, holeCardsWorldPT.y + 60); //console.log("holeCardsWorldPT: " + holeCardsWorldPT + ", holeCardsTextTipsWorldPT: " + holeCardsTextTipsWorldPT + ", holeCardsFocusMaskWorldPT: " + holeCardsFocusMaskWorldPT);
    ...
    var holeCardsMaskPos = this.holeCardsFocusMask.getPosition();
  ...
  _initFlopTutorial: function _initFlopTutorial() {
    //计算Flop各蒙层坐标
    ...
    this.dealPublicCards[2].setPosition(PositionData.CommunityCardPositions[2].x, PositionData.CommunityCardPositions[2].y); // this.dealPublicCards[0].active = true;
    // this.dealPublicCards[1].active = true;
    // this.dealPublicCards[2].active = true;

    var fpoker0 = this.dealPublicCards[0].getChildren()[0].getComponent('Poker');
    var fpoker1 = this.dealPublicCards[1].getChildren()[0].getComponent('Poker');
    var fpoker2 = this.dealPublicCards[2].getChildren()[0].getComponent('Poker');
    ...
    var flop2Anchor = cc.find("Canvas/PublicCardsLayer/FlopCard_2");
    var flop2WorldPT = flop2Anchor.convertToWorldSpaceAR(cc.v2(0, 0));
    var flopTextTipsWorldPT = cc.v2(flop2WorldPT.x, flop2WorldPT.y + 140);
    var flopFocusMaskWorldPT = cc.v2(flop2WorldPT.x, flop2WorldPT.y + 50); //console.log("flop2WorldPT: " + flop2WorldPT + ", flopTextTipsWorldPT: " + flopTextTipsWorldPT + ", flopFocusMaskWorldPT: " + flopFocusMaskWorldPT);
    ...
    var flopMaskPos = this.flopFocusMask.getPosition();
  ...
  _initTurnTutorial: function _initTurnTutorial() {
    //计算Turn各蒙层坐标
    this.dealPublicCards[3].setPosition(PositionData.CommunityCardPositions[3].x, PositionData.CommunityCardPositions[3].y); // this.dealPublicCards[3].active = true;

    var tpoker = this.dealPublicCards[3].getChildren()[0].getComponent('Poker');
    tpoker.setCardPoint(9);
    tpoker.setFaceUp(true);
    var turnAnchor = cc.find("Canvas/PublicCardsLayer/TurnCard");
    var turnWorldPT = turnAnchor.convertToWorldSpaceAR(cc.v2(0, 0));
    var turnTextTipsWorldPT = cc.v2(turnWorldPT.x, turnWorldPT.y + 140);
    var turnFocusMaskWorldPT = cc.v2(turnWorldPT.x, turnWorldPT.y + 50); //console.log("turnWorldPT: " + turnWorldPT + ", turnTextTipsWorldPT: " + turnTextTipsWorldPT + ", turnFocusMaskWorldPT: " + turnFocusMaskWorldPT);
    ...
    var turnMaskPos = this.turnFocusMask.getPosition();
  ...
  _initRiverTutorial: function _initRiverTutorial() {
    //计算River各蒙层坐标
    this.dealPublicCards[4].setPosition(PositionData.CommunityCardPositions[4].x, PositionData.CommunityCardPositions[4].y); // this.dealPublicCards[4].active = true;

    var rpoker = this.dealPublicCards[4].getChildren()[0].getComponent('Poker');
    rpoker.setCardPoint(10);
    rpoker.setFaceUp(true);
    var riverAnchor = cc.find("Canvas/PublicCardsLayer/RiverCard");
    var riverWorldPT = riverAnchor.convertToWorldSpaceAR(cc.v2(0, 0));
    var riverTextTipsWorldPT = cc.v2(riverWorldPT.x, riverWorldPT.y + 140);
    var riverFocusMaskWorldPT = cc.v2(riverWorldPT.x, riverWorldPT.y + 50); //console.log("riverWorldPT: " + riverWorldPT + ", riverTextTipsWorldPT: " + riverTextTipsWorldPT + ", riverFocusMaskWorldPT: " + riverFocusMaskWorldPT);
    ...
    var riverMaskPos = this.riverFocusMask.getPosition();
  ...
  _initShowdownTutorial: function _initShowdownTutorial() {
    //计算摊牌轮各蒙层坐标
    var turnWorldPT = cc.find("Canvas/PublicCardsLayer/TurnCard").convertToWorldSpaceAR(cc.v2(0, 0));
    var holeCardsWorldPT = cc.find("Canvas/HoldCardsLayer").convertToWorldSpaceAR(cc.v2(0, 0));
    var ctWorldPT = this.cardType.node.convertToWorldSpaceAR(cc.v2(0, 0));
    console.log("turnWorldPT: " + turnWorldPT + ", holeCardsWorldPT: " + holeCardsWorldPT + ", ctWorldPT: " + ctWorldPT); //镂空层定位
    ...
    var ctMaskWorldPT = this.cardType.node.convertToWorldSpaceAR(cc.v2(0, 0));
    ctMaskWorldPT.x += 170;
    this.showdownCardTypeFocusMask.setPosition(this.showdownCardTypeFocusMask.parent.convertToNodeSpaceAR(ctMaskWorldPT));
    var ctTipsWorldPT = this.cardType.node.convertToWorldSpaceAR(cc.v2(0, 0));
    ctTipsWorldPT.x += 253;
    this.showdownCardTypeTextTips.setPosition(this.showdownCardTypeTextTips.parent.convertToNodeSpaceAR(ctTipsWorldPT)); //阴影的高度与位置

    var communityShadowWorldPT = cc.v2(cc.winSize.width / 2, holeCardsWorldPT.y + (turnWorldPT.y - holeCardsWorldPT.y) / 2);
    var holeCardsShadowWorldPT = cc.v2(cc.winSize.width / 2, ctWorldPT.y + (holeCardsWorldPT.y - ctWorldPT.y) / 2);
    var ctShadowWorldPT = cc.v2(cc.winSize.width / 2, 0);
  ...
  _initButtonLayer: function _initButtonLayer() {
    var pos = cc.find("Canvas/ButtonLayer/btnPlayNow").convertToWorldSpaceAR(cc.v2(0, 0));
    pos.y -= 102;
    pos.y -= cc.find("Canvas/ButtonLayer/btnPlayNow").height;
    var btnMoreRules = cc.find("Canvas/ButtonLayer/btnMoreRules");
