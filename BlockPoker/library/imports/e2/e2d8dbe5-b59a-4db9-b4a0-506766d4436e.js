"use strict";
cc._RF.push(module, 'e2d8dvltZpNubSgUGdm1ENu', 'ClubMemberItem');
// scripts/Game/ClubMemberItem.js
...
cc.Class({
  ...
  init: function init(addr, ownerAddr) {
  ...
  unpreSelect: function unpreSelect() {
