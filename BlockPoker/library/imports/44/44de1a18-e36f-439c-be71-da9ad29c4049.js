"use strict";
cc._RF.push(module, '44de1oY429DnL5x2prSnEBJ', 'Net');
// scripts/Net/Net.js
...
var Global = cc.Class({
  ...
  statics: {
    ...
    _addHandler: function _addHandler(msgid, fn) {
    ...
    */
    removeAllMsg: function removeAllMsg() {
      Log.Trace("removeAllMsg");
      this._handlers = {};
    },
    _eventHandler: function _eventHandler(result) {
      this._subscriptionid2eventName;
    },
    addEventListener: function addEventListener(params, eventHandler) {
      var data = {
        jsonrpc: "2.0",
      ...
      this._subeventName2msgid[params[0]] = data.id; //this.netControl.send(JSON.stringify(data));
    ...
    removeEventListener: function removeEventListener(params) {
      ...
      if (this._eventName2subscriptionid[params[0]] != null) {
        ...
        this._unsubeventName2msgid[params[0]] = data.id; //this.netControl.send(JSON.stringify(data));
    ...
    _isSubscriptionMsgid: function _isSubscriptionMsgid(msgid) {
      for (var eventName in this._subeventName2msgid) {
        if (this._subeventName2msgid[eventName] == msgid) return eventName;
      }

      return null;
    },
    _isUnsubscriptionMsgid: function _isUnsubscriptionMsgid(msgid) {
      for (var eventName in this._unsubeventName2msgid) {
        if (this._unsubeventName2msgid[eventName] == msgid) return eventName;
      }
    ...
    */
    onMessage: function onMessage(jsonstr) {
    ...
    gameCall: function gameCall(params, msgHandler) {
      var data = {
        jsonrpc: "2.0",
        method: "dgame_call",
        params: params,
