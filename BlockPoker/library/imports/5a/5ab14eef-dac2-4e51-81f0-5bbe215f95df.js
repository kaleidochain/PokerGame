"use strict";
cc._RF.push(module, '5ab147v2sJOUYHwW74hX5Xf', 'LoginAccount');
// scripts/Wallet/LoginAccount.js
...
cc.Class({
  ...
  onBtnChangeCurrentAccountClicked: function onBtnChangeCurrentAccountClicked() {
    this.selectAccountPopup.active = true;
    this.loadLocalAccounts();
  },
  onBtnCloseSelectAccountPopupClicked: function onBtnCloseSelectAccountPopupClicked() {
  ...
  loadLocalAccounts: function loadLocalAccounts() {
  ...
  // update (dt) {},
  //点击下拉列表中的昵称会调用
  tryVerifyAccount: function tryVerifyAccount(nickname, addr) {
  ...
  tryNewAccount: function tryNewAccount() {
    this.selectAccountPopup.active = false;
    cc.dgame.sceneList.push(cc.director.getScene().name);
  ...
  onBtnLoginClicked: function onBtnLoginClicked() {
    var testAddrMap = this._getTestAddrMap();
  ...
  _getTestAddrMap: function _getTestAddrMap() {
    var addrMap = {
  ...
  onEditingPasswordBegan: function onEditingPasswordBegan() {
