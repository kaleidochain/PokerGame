//run:truffle exec ./test/notaryInsure.js --network product
...
var provider = new HDWalletProvider("067a1d264d142656d5a70c052f9cf90c35d01da9893d3af2ba49274717f9c340", host);
var owner = null;
...
module.exports = async function(exit) {
	try{
        var ok = await init();
        if(!ok)exit(0);
        console.log("init success", "portal", portal.address, "game", game.address);

        // var data = await game.getPlayerInfo.call("0xFa095c1E2BE35eF9A91cA35a5574Ec9b02dF9B85");
        // console.log(data[0], data[1]*1, data[2]*1, data[3]*1, data[4]*1, data[5]*1);
        var data = [3, 4, 6, 0, 0, 0];
        console.log(data);
        var rlpdata = utils.rlp.encode(data);
        console.log(rlpdata);
        var tx = await game.notaryInsure("0xFa095c1E2BE35eF9A91cA35a5574Ec9b02dF9B85", rlpdata, {from:accounts[1], gas:6000000});
        console.log(tx);
// //检查
