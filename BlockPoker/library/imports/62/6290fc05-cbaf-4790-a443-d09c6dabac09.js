"use strict";
cc._RF.push(module, '6290fwFy69HkKRD0Jxtq6wJ', 'ClubGameTableList');
// scripts/Game/ClubGameTableList.js
...
cc.Class({
  ...
  selectGameTable: function selectGameTable(tableId) {
    for (var i in this.content.getChildren()) {
      var item = this.content.getChildren()[i].getComponent("ClubGameTableItem");
