"use strict";
cc._RF.push(module, '52b9fAVyvFHeZGCkORsiXZy', 'CreateAccount');
// scripts/Wallet/CreateAccount.js
...
cc.Class({
  ...
  onLinkLoginMnemonicClicked: function onLinkLoginMnemonicClicked() {
      ...
      if (cc.sys.isNative) {
        ...
        if (cc.sys.isMobile) {
          if (cc.sys.os === cc.sys.OS_IOS) {
            ret = jsb.reflection.callStaticMethod("NativeGengine", "createAccount:", this.editPassword.string);
          } else if (cc.sys.os === cc.sys.OS_ANDROID) {
            ret = jsb.reflection.callStaticMethod("io/kaleidochain/NativeGengine", "createAccount", "(Ljava/lang/String;)Ljava/lang/String;", this.editPassword.string);
          }
        } else {
  ...
  onBtnCreateAccountByPasswordClicked: function onBtnCreateAccountByPasswordClicked() {
    this.toast.active = true;
  },
  onBtnMnemonicToastOKClicked: function onBtnMnemonicToastOKClicked() {
    this.toast.active = false;
    this.createAccountByPassword();
  },
  onBtnMnemonicToastCancelClicked: function onBtnMnemonicToastCancelClicked() {
    this.toast.active = false;
  },
  createAccountByPassword: function createAccountByPassword() {
    if (cc.sys.isNative) {
      var accountInfo = {};
  ...
  onBtnCopyMnemonicToClipboardClicked: function onBtnCopyMnemonicToClipboardClicked() {
